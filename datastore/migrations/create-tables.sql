...
INSERT INTO recipes (name, ingredients, method) VALUES ('Lazy Lasnge', concat('3 tbsp Olive oil', CHR(13),CHR(10), '1 onion, finely chopped ', CHR(13),CHR(10), '3 garlic gloves, crushed ', CHR(13), CHR(10), '200 ml milk ', CHR(13), CHR(10), '2 bay leaves ', CHR(13), CHR(10), '500 ml red wine'), concat('1. First, make the béchamel sauce. ', CHR(13), CHR(10), '2. For the meat sauce, put the oil, celery, onion, carrot, garlic and pancetta in another large saucepan. ', CHR(13), CHR(10),'3. Tip in the beef and pork mince, the milk and chopped tomatoes. ', CHR(13), CHR(10),'4. Heat the oven to 180C/160C'));